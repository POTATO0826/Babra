  ...
  try {
    const result = await generateText({
      ...
      system: [
        ...
        "Keep activity concise as the underlying client moment.",
        "suggestedTouchpoint must be a practical message the advisor can say to the client, not another summary of the post.",
        "Write suggestedTouchpoint as warm, natural outreach copy or a concrete conversation opener. Examples: 'Wish them a safe trip and ask what they are most excited to see in Tokyo.', 'Ask how the Golden Week visit went and whether Okazaki Castle lived up to expectations.', 'Congratulate them on the milestone and ask how the family is celebrating.'",
        "Avoid wording like 'Client visited...', 'Client began...', 'Client continued...', or 'indicating...'. The suggestedTouchpoint should start with an advisor action like Ask, Wish, Congratulate, Check in, or Mention.",
